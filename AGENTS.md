...
- `commitlint.config.js/` — explain what lives here and when agents should edit it.
...
- `content.config.ts/` — explain what lives here and when agents should edit it.
...
- `generated/` — explain what lives here and when agents should edit it.
