...
const partners = [
  {
    ...
    logo: 'https://d2dna.com/wp-content/uploads/2024/04/albert-einstein.png'
  },
  {
    name: 'Vital Strategies',
    logo: 'https://d2dna.com/wp-content/uploads/2024/04/vital-strategies.png'
  },
  ...
  { name: 'Bioinfor USP', logo: 'https://d2dna.com/wp-content/uploads/2024/04/bioinfor-usp.png' },
  {
    ...
    logo: 'https://d2dna.com/wp-content/uploads/2024/04/hospital-los-angeles.png'
  },
...
<template>
  ...
  >
    <h2 id="partners-heading" class="text-2xl font-bold text-foreground mb-4 text-center">
      Quem Confia na D2DNA
    </h2>
    <p class="text-center text-muted-foreground mb-8 text-sm">
      De hospitais de referência a universidades de ponta — nossa tecnologia opera onde erro não é
      opção.
    </p>
    ...
    <div
      id="partners"
      class="grid grid-cols-2 gap-px bg-border/20 border border-border/20 max-w-4xl mx-auto md:grid-cols-3"
    >
      <div
      ...
      >
        ...
        />
        <span
          class="text-xs text-muted-foreground/40 group-hover:text-muted-foreground/70 font-mono transition-colors duration-300 text-center leading-tight"
        >
          {{ partner.name }}
        </span>
      </div>
